...
<body>
   ...
   <!-- <div class="main" id='main'>
    ...
    <header class="header">
        ...
        <li><a href="" id="user">Hi!<span><?=$_SESSION['user_name'][0]?></span></a>
        <ul class="sub">
            <span>S</span>
            <p><?=$_SESSION['user_email']?></p>
            <p><?=$_SESSION['user_name']?></p>
            <div class="btn1">
                <a href="/myphp-1/e-com-7/fms/dashboard.php">Dashboard</a>
                <a href="/myphp-1/e-com-7/fms/home.php">Logout</a>
            </div>
        </ul>
        </li>
    </header>
...
<div class="mealtimes">
    <div class="breakft">
        <h2>Breakfast Order <i class="bi bi-x-circle-fill cancle3"></i></h2>
        <p>Make your order as you wish!</p>
        <form action="register.php" method="POST">
            <div class="frm-g">
                <input type="text" value="<?=$_SESSION['user_name']?>" name="name">
            </div>
            <div class="frm-g">
                <input class="date" type="text" value= "" name="date">
            </div>
            <div class="frm-g">
                <input type="text" class="time" value="time" name="time">
            </div>
            <div class="frm-g">
                <input class="num" type="number" value="1" name="count">
            </div>
            <div class="frm-g">
                <input class="price" type="text" value="" name="price">
            </div>

            <input type="hidden" value="Breakfast" name="type">

            <input type="submit" value="Pay" name="btn3">
        </form>
...
<div class="mealtimes ">
    <div class="breakft">
        <h2>Lunch Order <i class="bi bi-x-circle-fill cancle3"></i></h2>
        <p>Make your order as you wish!</p>
        ...
        <form action="register.php" method="POST">
            ...
            <div class="frm-g">
                <input type="text" class="date" value="date" name="date">
            </div>
            <div class="frm-g">
                <input type="text" class="time" value="time" name="time">
            </div>
            ...
            <input type="hidden" value="Lunch" name="type">
...
<div class="mealtimes ">
    <div class="breakft">
        <h2>Dinner Order <i class="bi bi-x-circle-fill cancle3"></i></h2>
        <p>Make your order as you wish!</p>
        <form action="register.php" method="POST">
            <div class="frm-g">
                <input type="text" value="<?=$_SESSION['user_name']?>" name="name">
            ...
            <div class="frm-g">
                <input class="time" type="text" value="time" name="time">
            </div>
            <div class="frm-g">
                <input class="num" type="number" value="1" name="count">
            </div>
            ...
            <input type="hidden" value="Dinner" name="type">
            <input type="submit" value="Pay" name="btn3">
        </form>
    </div>
